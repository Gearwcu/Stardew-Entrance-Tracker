...
const CHECKS_XOFFSET  = 182;
const CHECKS_YOFFSET  = 9;

const MAP_MARK_OFFSET = 1;
const MAP_MARK_WIDTH  = 5;
...
const TOOLTIP_SIZEX = 260;
const TOOLTIP_SIZEY = 70;
const TOOLTIP_XOFFSET = -265;
const TOOLTIP_YOFFSET = -20;
const TOOLTIP_CENTERTEXT = 20;
...
function RenderRemainingIcon(context) {
    ...
    context.imageSmoothingEnabled = false;
    let v = {
        x: game.left_width - CHECKS_XOFFSET + 40,
...
function RenderTooltip(context) {
    ...
    context.save(); {
        ...
        switch (lines.length) {
            ...
            default: {
                console.error("ERROR: Text can't have more than 2 lines! Only rendering the 2 first lines.");
            } // falldown
            case 2: {
