let stardew8 = {
    ...
    // Config texts
	config_name: "Stardew Valley 8.xER Tracker",
    ...
    locations: {
        ...
        onewaywarps: { x: 1460, y: 50, w: 600, h: 750, name: "Obelisks" }
    },
    ...
    warps: {
        town: {
            clinic_entry: { x: 258, y: 393, name:"Clinic Entry", text_offset: { x: -0.12, y: -.07 } },
            ...
            //8.xER
            town_bus:{x: 18, y: 392 },
            town_forest:{x: 18, y: 680 },
            town_mountain:{x: 594, y: 13, text_offset: {x:-0.03,y:0} },
            town_beach:{x: 392, y: 786 },
            town_tide:{x: 692, y: 786 },
            town_mount_short_west:{x: 666, y: 58 },
            town_mount_short_east:{x: 728, y: 13, text_offset: {x:0.04,y:0} },
            minecart_town_to_q:{x: 820, y: 433 },
            minecart_town_to_bus:{x: 820, y: 478 },
            minecart_town_to_mine:{x: 820, y: 523 }
        },

        town_indoors: {
            clinic_exit: { x: 258, y: 393, text_offset: { x: -0.12, y: -.07 }, name: "Clinic" },
            harvey_entry: { x: 209, y: 336, name: "Clinic" },
        ...
        farm: {
            farmhouse_entry: {x: 535, y: 531 },
            farmhouse_exit: {x: 535, y: 481, name: "Farmhouse" },
            farmcave_entry: {x: 133, y: 443, text_offset: { x: -0.05, y: 0 }},
            farmcave_exit: {x: 133, y: 393, name: "Farmcave", text_offset: { x: -0.05, y: 0}},
            tunnel_entry: {x: 319, y: 286, name: "Backwood Road" },
            tunnel_exit: {x: 318, y: 232, name: "Bus Tunnel" },
            //8.xER
            cellar_entry: {x: 360, y: 551, name: "Farmhouse"},
            cellar_exit: {x: 360, y: 601, name: "Cellar"},
            farm_backwoods: {x: 224, y: 407, text_offset: { x: 0.07, y: -0.03 }},
            farm_bus:{x: 622, y: 628 },
            farm_forest: {x: 200, y: 629},
            farm_greenhouse_entry: {x: 54, y: 554, name: "Greenhouse Entry", text_offset: { x: 0.03, y: 0 }},
            farm_greenhouse_exit: {x: 54, y: 503, name: "Greenhouse", text_offset: { x: 0.03, y: 0 }},
            backwood_farm: {x: 224, y: 357, name: "Backwood Top", text_offset: { x: 0.07, y: -0.03 }},
            backwood_mountain: {x: 586, y: 125 , name: "Backwood Top"},
            backwood_bus: {x: 585, y: 282, name: "Backwood Road"},
            bus_farm: {x: 791, y: 560, name: "Bus Stop"},
            bus_town: {x: 1196, y: 560, name: "Bus Stop"},
            bus_bus: {x: 926, y: 353, name: "Bus Stop", text_offset: { x: 0.07, y: 0 }},
            bus_road: {x: 798, y: 353, name: "Bus Stop"},
            minecart_bus_to_q: {x: 830, y: 97, name: "Bus Stop"},
            minecart_bus_to_town: {x: 830, y: 147, name: "Bus Stop"},
            minecart_bus_to_mine: {x: 830, y: 197, name: "Bus Stop"},
            farm_totem_exit: {x: 352, y: 445},
            farm_obelisk_exit: {x: 352, y: 495},
            return_scepter_exit: {x: 535, y: 581}
        ...
        mountain: {
            ...
            treehouse_entry: { x: 237, y: 804, name: "Treehouse Entry" },
            linus_entry: { x: 453, y: 797,  text_offset: { x: .08, y: 0 } },
            mines_entry: { x: 854, y: 759,name: "Mountain East" },
            ...
            mountain_backwood:{x: 51, y: 892, text_offset: {x:0.05}},
            mountain_rail:{x: 134, y: 738, text_offset: {x:0,y:-0.08}},
            mountain_town:{x: 263, y: 1325 },
            mountain_shortcut_west:{x: 901, y: 1325 },
            mountain_shortcut_east:{x: 1350, y: 1325, name: "Mountain East"},
            minecart_q_to_bus:{x: 1960, y: 456, name: "Quarry"},
            minecart_q_to_town:{x: 1960, y: 546, name: "Quarry"},
            minecart_q_to_mine:{x: 1960, y: 636, name: "Quarry"},
            rail_mountain: {x: 588, y: 645, name: "Railroad"},
            mountain_totem_exit:{x: 486, y: 954},
            earth_obelisk_exit:{x: 486, y: 1034 }
        },
        ...
        mountain_indoors: {
            ...
            bathhouse_exit: { x: 275, y: 420, name: "Bath Hall", text_offset: { x: -.07, y: 0 } },
            ...
            minecart_mine_to_q:{x: 850, y: 941, name: "The Mines"},
            minecart_mine_to_bus:{x: 850, y: 1031, name: "The Mines"},
            minecart_mine_to_town:{x: 850, y: 1121, name: "The Mines"},
        ...
        beach: {
            ...
            //8.xER
            beach_town:{x: 916, y: 33 },
            beach_short_forest:{x: 13, y: 111 },
            beach_short_tide:{x: 1362, y: 46 },
            boat_tunnel_ticket:{x: 968, y: 700, name: "Boat"},
            boat_exit:{x: 968, y: 785, name: "Boat"},
            water_obelisk_exit:{x: 477, y: 46 },
            beach_totem_exit:{x: 477, y: 124 }
        },
        ...
        forest: {
            ...
            //8.xER
            forest_farm:{x: 732, y: 16 },
            forest_town:{x: 1220, y: 242 },
            forest_short_beach: {x: 1230, y: 406 },
            woods_entry:{x: 67, y: 93 },
            secret_woods:{x: 67, y: 16, name: "Secret Woods"}
        ...
        island_west: {
            ...
            gourmand_entry: { x: 946, y: 321,name:"Island Farm" },
            shipwwreck_entry: { x: 621, y: 907 },
            crystal_entry: { x: 591, y: 88 },
            ...
            //8.xER
            isle_west_south:{x: 976, y: 398},
            parrot_farm_volcano:{x: 799, y: 10 },
            parrot_farm_dig:{x: 799, y: 75 },
            parrot_farm_jungle:{x: 799, y: 140 },
            parrot_farm_dock:{x: 799, y: 195 },
            farm_obelisk:{x: 696, y: 272 }
        },	
    
        island_north: {
            snail_cave_entry: { x: 201, y: 402, name: "Dig Site", text_offset: { x: 0.04, y: 0 } },
            ...
            //8.xER
            isle_north_south:{x: 334, y: 817, text_offset: {x:-0.08,y:0} },
            isle_north_ridge:{x: 444, y: 817, text_offset: {x:+0.02,y:0} },
            parrot_dig_volcano:{x: 63, y: 439, name: "Dig Site" },
            parrot_dig_farm:{x: 63, y: 486, name: "Dig Site" },
            parrot_dig_jungle:{x: 63, y: 528, name: "Dig Site" },
            parrot_dig_dock:{x: 63, y: 570, name: "Dig Site" },
            parrot_volcano_farm:{x: 565, y: 10 },
            parrot_volcano_dig:{x: 565, y: 57 },
            parrot_volcano_jungle:{x: 565, y: 104 },
            parrot_volcano_dock:{x: 565, y: 151 }
            //volcano_f5_hole?
        ...
        island_south: {
            boat: {x: 162, y: 723 },
            pirate_cove_entry: { x: 690, y: 582, name:"Island Southeast" },
            pirate_cove_exit: { x: 690, y: 540, name: "Pirate Cove" },
            islandhut_entry: {x: 545, y: 68, name: "Island East" },
            islandhut_exit: {x: 545, y: 24, name: "Island Treehouse" },
            shrine_entry: { x: 677, y: 256, name: "Island East" },
            shrine_exit: { x: 677, y: 214, name: "Gembirds" },
            //8.xER
            isle_south_west:{x: 7, y: 440, text_offset: {x:-0.09,y:0} },
            isle_south_north:{x: 149, y: 345, text_offset: {x:-0.03,y:0} },
            isle_south_ridge:{x: 250, y: 345, name: "Island South Ridge", text_offset: {x:+0.05,y:0} },
            isle_south_east:{x: 282, y: 440 },
            isle_south_se:{x: 319, y: 588 },
            parrot_dock_volcano: {x: 56, y: 535 },
            parrot_dock_farm: {x: 56, y: 577 },
            parrot_dock_dig: {x: 56, y: 619 },
            parrot_dock_jungle: {x: 56, y: 661 },
            isle_east_west:{x: 416, y: 383, name: "Island East" },
            parrot_jungle_volcano:{x: 426, y: 143, name: "Island East" },
            parrot_jungle_farm:{x: 426, y: 185, name: "Island East" },
            parrot_jungle_dig:{x: 426, y: 227, name: "Island East" },
            parrot_jungle_dock:{x: 426, y: 269, name: "Island East" },
            isle_se_west:{x: 401, y: 619, text_offset: {x:0,y:0.04}, name: "Island Southeast" },
            island_obelisk_exit:{x: 113, y: 432 },
            island_totem_exit:{x: 113, y: 474 }
        },
        ...
        desert: {
            ...
            //8.xER
            desert_bus:{x: 437, y: 609 },
            desert_obelisk_exit:{x: 829, y: 938 },
            desert_totem_exit:{x: 829, y: 1032 }
        },
